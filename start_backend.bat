@echo off
chcp 65001 >nul
title RepoScroller - Backend API & Web Dashboard (:8090)

echo ================================================================
echo    RepoScroller - Backend API & Web Dashboard Service
echo ================================================================
...
uv run python -m reposcroller.main serve --host 127.0.0.1 --port 8090
